...
3.  **Configure environment variables:**
    ...
    *   **`MONGODB_URI`**: The connection string to your MongoDB Atlas database. Example: `mongodb+srv://<username>:<password>@cluster0.mongodb.net/jewelry_store?retryWrites=true&w=majority`. 
     **Important:  Ensure network access is configured correctly in MongoDB Atlas to allow connections from Render.**
    *   **`JWT_SECRET`**:  A strong, randomly generated secret key for signing JWTs. Generate a key using: `openssl rand -base64 32`.
